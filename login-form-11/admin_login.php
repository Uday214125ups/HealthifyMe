				...
				<div class="col-md-7 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Sign In</h3>
		      		...
		      		<div class="form-group">
		      			<input type="text" name=admin_name class="form-control rounded-left" placeholder="Username" required>
		      		</div>
	            <div class="form-group d-flex">
	              <input type="password" name=admin_pass class="form-control rounded-left" placeholder="Password" required>
	            </div>
	            <div class="form-group">
