...
$sql1= "SELECT * from patients where patient_id='".$_SESSION['patient']."'";
...
?><span></span></p>
            ...
            <a href=baa.php>  <button type="button" class="btn btn-primary">Book an Appointment</button></a>
...
$sql1= "SELECT name from patients where patient_id='".$_SESSION['patient']."'";
$result1 = mysqli_query($conn,$sql1);      
