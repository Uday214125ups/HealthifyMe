    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="card mb-4">
          ...
          <i class="fas fa-user fa-3x"></i>            <h5 class="my-3">
            <?php
...
?></p>
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          <div class="card-body">
              <form method=post action=edit_patient_details.php>
            <div class="row">
              <div class="col-sm-3">
...
?>" aria-label="Username" >
                ...
                <!--<input type=text value="Johnatan Smith">-->
              </div>
            </div>
            <hr>
            <div class="row">
...
?>" aria-label="Username" aria-describedby="basic-addon1">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                   <textarea class="form-control" name='address' aria-label="Username" aria-describedby="basic-addon1"><?php
...
?></textarea>
            ...
            <hr>
            <a href="patient_profile_edit.php"> <button type="submit" class="btn btn-outline-primary ms-1">Save</button></a>
