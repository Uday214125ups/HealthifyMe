...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <center>   <a href=login-form-11/doctor_login.php><button type="button" class="btn btn-warning" >Doctor</button></a><br><br>
       <a href=login-form-11/patient_login.php> <button type="button" class="btn btn-primary">Patient</button></a><br><br>
      <a href=login-form-11/admin_login.php> <button type="button" class="btn btn-danger">Admin</button></a></center>
      </div>
    </div>
  </div>
</div>
            ...
            <div class="container">
               <div class="row slider-row">
                   <div class="col-md-7  animate__animated animate__fadeInLeft contentcol">
                        <h2>Professional & Highly Quality <br> Health Services</h2><br>
                       ...
                       <a href="login-form-11/patient_login.php"> <button type="button" class="btn btn-outline-primary">Personalised Health Checkup</button></a><button type="button"  id="btn" class="btn btn-info btn-lg" data-toggle="modal" data-target="#success_tic" style="display:none;">Open Modal</button>
                    </div>
...
<div id="success_tic" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="page-body">
    <div class="head">  
      <h3 style="margin-top:5px;">Log Out Successfull</h3>
      <h4></h4>
    </div>
